...
import { Lock, User as UserIcon, Mail, AtSign, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-zinc-950 px-4 py-12">
      {/* Container */}
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-xs text-zinc-400">Join Loop Chat today</p>
        </div>
        ...
        <div className="panel-card p-8 rounded-2xl shadow-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('name')}
                  className={`w-full bg-zinc-950 border ${
                    errors.name ? 'border-red-500/40 focus:border-red-500' : 'border-zinc-800 focus:border-zinc-600'
                  } text-zinc-100 pl-10 pr-4 py-2.5 rounded-xl outline-none text-xs transition-all placeholder-zinc-650`}
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('email')}
                  className={`w-full bg-zinc-950 border ${
                    errors.email ? 'border-red-500/40 focus:border-red-500' : 'border-zinc-800 focus:border-zinc-600'
                  } text-zinc-100 pl-10 pr-4 py-2.5 rounded-xl outline-none text-xs transition-all placeholder-zinc-650`}
                />
              </div>
              {errors.email && (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-3 bg-zinc-100 hover:bg-zinc-200 text-zinc-950 font-bold py-2.5 px-4 rounded-xl text-xs transition-all flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.005] active:scale-[0.995]"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center text-xs text-zinc-400">
            ...
            <Link href="/login" className="text-zinc-100 hover:underline font-bold transition-all">
              Sign In
            </Link>
          </div>
        </div>
